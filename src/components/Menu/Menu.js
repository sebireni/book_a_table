  ...
  return (
    <section id="menuSection">
      <div id="pizza">
        ...
        <ul id="pizzaPie">
          <li>
            <img id="one" src={first} alt="salami pizza slice" />
          </li>
          <li>
            <img id="two" src={second} alt="olive pizza slice" />
          </li>
          <li>
            <img id="three" src={third} alt="margarita pizza slice" />
          </li>
          <li>
            <img id="four" src={fourth} alt="shrimp pizza slice" />
          </li>
          <li>
            <img id="five" src={fifth} alt="mushroom pizza slice" />
          </li>
          <li>
            <img id="six" src={sixth} alt="vegetarian pizza slice" />
          </li>
        </ul>
