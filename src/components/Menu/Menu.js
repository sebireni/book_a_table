    ...
    return (
        <section id="menuSection">
            ...
            <div id="pizza">
                ...
                <ul id="pizzaPie">
                    <li>
                    <img id="one" src={first} alt="" /></li>
                    <li><img id="two" src={second} alt="" /></li>
                    <li><img id="three" src={third} alt="" /></li>
                    <li><img id="four" src={fourth} alt="" /></li>
                    <li><img id="five" src={fifth} alt="" /></li>
                    <li><img id="six" src={sixth} alt="" /></li>
                </ul>
            ...
            <div id="pizzaMob">
                ...
                <ul id="pizzaList">
                    <li>
                        <img id="oneMob" src={thirdRot} alt="" />
                    ...
                    <li>
                        <img id="twoMob" src={firstRot} alt="" />
                    ...
                    <li>
                        <img id="threeMob" src={secondRot} alt="" />
                    ...
                    <li>
                        <img id="fourMob" src={sixthRot} alt="" />
                    ...
                    <li>
                        <img id="fiveMob" src={fourthRot} alt="" />
                    ...
                    <li>
                        <img id="sixMob" src={fifthRot} alt="" />
